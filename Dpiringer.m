...
'AdhNaturalRubber'  , struct('App',11.3,'tau',-421),...
'AdhSyntheticRubber', struct('App',11.3,'tau',-421),...
'AdhEVA'            , struct('App',6.6 ,'tau',-1270),...
'AdhVAE'            , struct('App',6.6 ,'tau',-1270),...
'AdhPVAC'           , struct('App',6.6 ,'tau',-1270),...
'AdhAcrylate'       , struct('App',4.5 ,'tau',83),...
'AdhPUR'            , struct('App',4   ,'tau',250),...
'AdhPaper'          , struct('App',6.6 ,'tau',-1900),...
'AdhCardboard'      , struct('App',4   ,'tau',-1511),...
'AdhCardboard_CH'   , struct('App',7.4 ,'tau',-1511) ...
    );
