function handle=colorbar_caxis(arg1, arg2, arg3)
...
if loc(1)=='v' % create or refresh vertical colorbar
    ...
    if isempty(ax)
        legendv6('RestoreSize',h); %restore axes to pre-legend size
        units = get(h,'units');
        ...
        legendv6('RecordSize',h); %set this as the new legend fullsize
