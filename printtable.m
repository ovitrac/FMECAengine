...
default = struct('parent',[],'nrowmaxperpage',20,'horizontalalignmentth','center','verticalalignmentth','middle','horizontalalignmenttd','center',...
                 ...
                 'numlayout',[],...
                 'paperposition',[0.4000    0.1774   20.5391   29.0000],'tablesubplotx',[],'tablesubploty',[],'imgsubplotx',[.2 .8 .1],'imgsubploty',[.05 .9 .05],'imgalive',5,'printon',false,'figurefolder',cd,'resolution',300);
styletr_default = 'td';
styleth_default = 'th';
